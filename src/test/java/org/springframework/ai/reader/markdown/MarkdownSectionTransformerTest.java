...
class MarkdownSectionTransformerTest implements WithAssertions {
    ...
    void testNoSubSplitter() {
        ...
        List<Document> segments = splitter.apply(List.of(source));
    ...
    void testIntroductoryTextNoHeaderWithDocumentTitle() {
        ...
        DocumentTransformer splitter =
                MarkdownSectionTransformer.builder().setDocumentTitle("Doc Title").build();
    ...
    void testSectionSplitter() {
        ...
        DocumentTransformer splitter = MarkdownSectionTransformer.builder()
     ...
     */
    private static DocumentTransformer wordBoundarySplitter(int maxSize) {
            return documents -> documents.stream().flatMap(document -> {
